...
- <a name="endpoint-service-acceptance">`service.beta.kubernetes.io/aws-load-balancer-endpoint-service-acceptance-required`</a> specifies whether request to attach an Endpoint to the Endpoint Service require manual acceptance.
